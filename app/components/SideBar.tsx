...
export default function SideBar({ isAdmin }: { isAdmin: boolean }) {
  ...
  return (
    <ul className="menu p-4 min-w-64 bg-base-200 text-base-content space-y-1">
      ...
      <li>
        <Link href="/" className={clsx({ "active": pathname === "/" })}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
      ...
      <li>
        <Link href="/projects" className={clsx({ "active": pathname === "/projects" })}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
      ...
      <li>
        <details open>
          ...
          <ul className="space-y-1">
            ...
            <li>
              <Link href="/issues" className={clsx({ "active": pathname === "/issues" })}>
                모든 일감
              </Link>
            </li>
          </ul>
        ...
        <li>
          <details open>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/admin/projects" className={clsx({ "active": pathname === "/admin/projects" })}>프로젝트 관리</Link>
              </li>
            </ul>
          </details>
        </li>
